...
`%LOCALAPPDATA%\Programs\bvx`, and adds that folder to your user `PATH`. It
...
- **`unsupported or undetected architecture` (Windows)** — force it explicitly
  and re-run:

  ```powershell
  $env:BVX_ARCH = "amd64"   # or "arm64"
  irm https://raw.githubusercontent.com/Brevitas-ai/brevitas/main/install.ps1 | iex
  ```
